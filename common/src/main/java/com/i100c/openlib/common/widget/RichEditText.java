package com.i100c.openlib.common.widget;
...
import com.i100c.openlib.common.adapter.TextWatcherAdapter;
import com.i100c.openlib.common.utils.Logger;
...
public class RichEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    private void replaceLastChar(@NonNull String chr, SpannableString spannable) {
        ...
        if (selStart == selEnd && selStart > 0
                ...
                && msg.getSpans(selStartBefore, selEnd, TagSpan.class).length == 0) {
